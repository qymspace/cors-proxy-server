...
function wrongURI(res) {
  ...
  ' <a href="https://github.com/qymspace/cors-proxy-spec">https://github.com/qymspace/cors-proxy-spec</a></p>');
}

function banner(res) {
  res.setHeader('Content-type', 'text/html');
  res.writeHead(200);
  res.end('<h1>CORS PROXY SERVER</h1><p><a href="https://github.com/qymspace/cors-proxy-server">' +
    'https://github.com/qymspace/cors-proxy-server</a></p>');
}
